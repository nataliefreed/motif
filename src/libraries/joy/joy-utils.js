...
export function _configure(target, config){
...
export function _numberToRoman(num){
    if (!+num)
        return NaN;
...
export function _numberToAlphabet(a){
...
export function _insertTextAtCursor(text){
  var sel, range, html;
...
export function _preventWeirdCopyPaste(element){
...
export function _selectAll(input, collapseToEnd){
...
export function _unselectAll(){
  var selection = window.getSelection();
    selection.removeAllRanges();
};
export function _fixStringInput(input){
...
export function _blurOnEnter(input){
...
export function _generateUID(obj){
  var num = 0;
  var id;
  do{
...
export function _forceToArray(thing){
...
//var _generateColor(obj){  };

// Remove all children from a DOM
export function _emptyDOM(node){
  while(node.hasChildNodes()) node.removeChild(node.lastChild);
};

// Get Query Param
// thx to https://stackoverflow.com/a/901144
export function _getParameterByName(name, url) {
...
export function _HSVToRGBString(h,s,v){
  if(arguments.length===1) {
...
// well, "random"
export const _randomHSVIndex = 0;
export const _randomHSVArray = [
      [0, 0.6, 1.0],
   [30, 0.8, 1.0],
  //[120, 0.9, 0.9],
  [210, 0.8, 1.0],
...
export function _forceToRGB(color){
