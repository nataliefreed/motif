<script lang='ts'>
  ...
  let colors = [
    ...
    '#FF5963','#FF857A','#FFA3A4','#FFC502','#FFBA15','#FFAB0B','#FD9325','#FD7920','#BFE2CD','#B9D9B4','#ACCC6B','#6D9F00','#039142','#99DDDE','#73DAD6', '#01B59D','#3DAEE6','#3D99CD','#B975C9','#AE62C0','#586D7F','#526673'
