<script lang="ts">
  ...
  import { scrollToAction, removeSelectedAction, repeatSelectedActionAlongPath, remixAction, duplicateAction, redrawSelectedAction, clearAllActions, undo } from './action-utils';
