...
class MotifApp {
	constructor(effectList) {
		...
		this.sketch = new P5Renderer(540, 540); //TODO: make this responsive
		...
		// const pageElement = document.querySelector('.left-page'); // or '.right-page'
    // const computedPageHeight = parseFloat(getComputedStyle(pageElement).height);
    // const numRings = Math.round(computedPageHeight / 40);
		this.ui.addNotebookRings(17);
